        ...
        <div class="container-xl ">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="<?php echo e(route('satuans.create')); ?>" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        <a href="<?php echo e(route('satuans.create')); ?>" class="btn btn-primary d-sm-none btn-icon"
                    ...
                    <div class="card">
                        <div class="table-responsive">
                            <table class="table table-vcenter table-mobile-md card-table">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $satuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="text-secondary align-text-top" data-label="No">
                                                <?php echo e($loop->iteration + $satuans->firstItem() - 1); ?>

                                            </td>


                                            <td class="align-text-top" data-label="Nama Satuan">
                                                <?php echo e($row->nama_satuan); ?>
                                            ...
                                            <td class="align-text-top">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end" style="">
                                                    <a class="dropdown-item" href="<?php echo e(route('satuans.edit', $row->id)); ?>">
                                                        <i class="ti ti-edit icon text-secondary me-2"></i>
                                                        Edit
                                                    </a>
                                                    <a class="dropdown-item text-danger" href="#"
                                                        onclick="handleDelete(`<?php echo e(route('satuans.destroy', $row->id)); ?>`)">
                        ...
                        <div class="card-footer d-flex justify-content-center align-items-center">
                            <?php echo e($satuans->onEachSide(1)->withQueryString()->withPath(request()->fullUrl())->links()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sisfo-barang-masuk-dan-keluar-main\resources\views/pages/satuans/index.blade.php ENDPATH**/ ?>