                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <div class="form-floating">
                                    ...
                                    <select class="form-select <?php $__errorArgs = ['pelangganId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->pelanggans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->id); ?>"><?php echo e($item->nama_pelanggan); ?>

                                            </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <!--[if ENDBLOCK]><![endif]-->
                                    </select>
                                    <label for="pelangganId">Pelanggan</label>
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['pelangganId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\xampp\htdocs\sisfo-barang-masuk-dan-keluar-main\resources\views/livewire/barang-keluar-create.blade.php ENDPATH**/ ?>