            ...
            <div class="row row-deck row-cards">
                ...
                <div class="col-12 col-lg-8">
                    <div class="card card-md">
                        <form action="<?php echo e(route('barang.update', $barang)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <div class="card-header">
                                <a href="<?php echo e(route('barang.index')); ?>" class="btn btn-icon">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="kode" value="<?php echo e(old('kode', $barang->kode)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="satuan_id"
                                                class="form-select <?php $__errorArgs = ['satuan_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="satuan_id">
                                                ...
                                                <?php $__currentLoopData = $satuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id); ?>" <?php if(old('satuan_id', $barang->satuan_id) == $item->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="kategori_id[]"
                                                class="form-select <?php $__errorArgs = ['kategori_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($item->id); ?>" <?php if(in_array($item->id, old('kategori_id', $barang->kategoris->pluck('id')->toArray()))): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="harga" value="<?php echo e(old('harga', $barang->harga)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="stok" value="<?php echo e(old('stok', $barang->stok)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="min_stok"
                                                value="<?php echo e(old('min_stok', $barang->min_stok)); ?>"
                                                class="form-control <?php $__errorArgs = ['min_stok'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" name="gambar" value="<?php echo e(old('gambar')); ?>" id="gambar"
...
unset($__errorArgs, $__bag); ?>" name="keterangan" rows="4"
                                                placeholder=""><?php echo e(old('keterangan', $barang->keterangan)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="card-footer">
                                <a href="<?php echo e(route('barang.index')); ?>" class="btn btn-outline-secondary w-25 ">Cancel</a>
        ...
        $(function() {
            ...
            const pond = FilePond.create(inputElement, {
                ...
                server: {
                    ...
                    process: '<?php echo e(route('filepond.store')); ?>',
                    revert: '<?php echo e(route('filepond.destroy')); ?>',
                    headers: {
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                    }
                },
                files: [{
                    source: '<?php echo e(Storage::disk('public')->url($barang->gambar)); ?>',
                    options: {
                        type: 'local',
                    },
                }],
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sisfo-barang-masuk-dan-keluar-main\resources\views/pages/barang/edit.blade.php ENDPATH**/ ?>