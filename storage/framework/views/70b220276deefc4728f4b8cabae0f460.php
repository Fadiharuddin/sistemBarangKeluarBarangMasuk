...
[$__name, $__params] = $__split('barang-masuk-create');

$__html = app('livewire')->mount($__name, $__params, 'lw-1793435294-0', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sisfo-barang-masuk-dan-keluar-main\resources\views/pages/barang-masuk/create.blade.php ENDPATH**/ ?>