            ...
            <div class="container-xl">
                ...
                <div class="navbar-nav flex-row order-md-last">
                    <div class="d-none d-md-flex">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="nav-link px-3 ">
                            Register
                        </a>
                        <a href="<?php echo e(route('login')); ?>" class="nav-link px-3">
                            Login
                        </a>
...
<?php /**PATH C:\xampp\htdocs\sisfo-barang-masuk-dan-keluar-main\resources\views/layouts/guest.blade.php ENDPATH**/ ?>