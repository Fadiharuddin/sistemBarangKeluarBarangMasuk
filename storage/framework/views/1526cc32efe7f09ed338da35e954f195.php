            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <a href="<?php echo e(route('barang.stok.pdf', [
                        ...
                        <a href="<?php echo e(route('barang.stok.excel', [
                            'from_date' => request()->query('from_date'),
                            'to_date' => request()->query('to_date'),
                        ])); ?>"
                            target="_blank" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        <a href="<?php echo e(route('barang.stok.excel')); ?>" class="btn btn-primary d-sm-none btn-icon"
                                        ...
                                        <tr>
                                            ...
                                            <td data-label="Barang">
                                                <div class="d-flex align-items-top">
                                                    ...
                                                    <div class="flex-fill">
                                                        <div class="font-weight-medium"><?php echo e($row->nama_barang); ?>
                                            ...
                                            <td class="align-text-top text-start text-lg-center" data-label="Stok">
                                                <?php echo e($row->totalBarangMasuk); ?>

                                            </td>

                                            <td class="align-text-top text-start text-lg-center" data-label="Stok">
                                                <?php echo e($row->totalBarangKeluar); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sisfo-barang-masuk-dan-keluar-main\resources\views/pages/barang/laporan/stok.blade.php ENDPATH**/ ?>