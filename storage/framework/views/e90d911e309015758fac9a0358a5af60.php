        ...
        <div class="container-xl ">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">
                        <?php echo e($barangMasuk->no_transaksi); ?>
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <a href="<?php echo e(route('barang-masuk.edit', $barangMasuk)); ?>"
                            class="btn btn-primary d-none d-sm-inline-block">
                            <i class="ti ti-edit icon me-2"></i>
                            Edit
                        </a>
                        <a href="#" class="btn btn-danger d-none d-sm-inline-block"
                            onclick="handleDelete(`<?php echo e(route('barang-masuk.destroy', $barangMasuk->id)); ?>`)">
                            <i class="ti ti-trash icon me-2"></i>
                            Hapus
                        </a>
                        <a href="<?php echo e(route('barang-masuk.create')); ?>" class="btn btn-primary d-sm-none btn-icon"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    ...
                                    <address>
                                        <?php echo e($barangMasuk->pemasok->nama_pemasok); ?><br>
                                        <?php echo e($barangMasuk->pemasok->alamat); ?><br>
                                        <?php echo e($barangMasuk->pemasok->notelp); ?><br>
                                        <?php echo e($barangMasuk->pemasok->email); ?>

                                    </address>
                                </div>
                                <div class="col-12 my-5">
                                    <div class="fs-2"><?php echo e($barangMasuk->no_transaksi); ?></div>
                                    <div><?php echo e(\Carbon\Carbon::parse($barangMasuk->tgl_masuk)->format('d M Y')); ?></div>
                                </div>
                            </div>
                            <table class="table table-transparent table-responsive">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $barangMasuk->barangMasukDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="text-center"><?php echo e($loop->iteration); ?></td>
                                            <td>
                                                <p class="strong mb-1"><?php echo e($item->barang->nama_barang); ?></p>
                                                <div class="text-secondary"><?php echo e($item->barang->kode); ?></div>
                                            </td>
                                            <td class="text-center">
                                                <?php echo e($item->barang->satuan->nama_satuan); ?>
                                            ...
                                            <td class="text-end text-nowrap">Rp. <?php echo e(number_format($item->harga)); ?></td>
                                            <td class="text-end text-nowrap">Rp. <?php echo e(number_format($item->total_harga)); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-weight-bold text-end text-nowrap">Rp.
                                            <?php echo e(number_format($barangMasuk->total_harga)); ?></td>
                                    </tr>
                                </tbody>
                            </table>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sisfo-barang-masuk-dan-keluar-main\resources\views/pages/barang-masuk/show.blade.php ENDPATH**/ ?>