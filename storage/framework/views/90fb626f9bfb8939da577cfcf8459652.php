                    ...
                    <div class="card card-md">
                        <form action="<?php echo e(route('pelanggan.store')); ?>" method="POST">
                            ...
                            <div class="card-header">
                                <a href="<?php echo e(route('pelanggan.index')); ?>" class="btn btn-icon">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nama_pelanggan" value="<?php echo e(old('nama_pelanggan')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="notelp" value="<?php echo e(old('notelp')); ?>"
                                                class="form-control <?php $__errorArgs = ['notelp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder=""><?php echo e(old('alamat')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="card-footer">
                                <a href="<?php echo e(route('pelanggan.index')); ?>" class="btn btn-outline-secondary w-25 ">Cancel</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sisfo-barang-masuk-dan-keluar-main\resources\views/pages/pelanggan/create.blade.php ENDPATH**/ ?>