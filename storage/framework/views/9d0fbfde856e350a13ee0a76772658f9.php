...
[$__name, $__params] = $__split('barang-keluar-edit', ['barangKeluar' => $barangKeluar]);

$__html = app('livewire')->mount($__name, $__params, 'lw-3933862410-0', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sisfo-barang-masuk-dan-keluar-main\resources\views/pages/barang-keluar/edit.blade.php ENDPATH**/ ?>