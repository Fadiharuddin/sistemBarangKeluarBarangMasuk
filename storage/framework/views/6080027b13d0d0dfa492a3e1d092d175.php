            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <a href="<?php echo e(route('barang-masuk.laporan.pdf', [
                        ...
                        <a href="<?php echo e(route('barang-masuk.laporan.excel', [
                            'from_date' => request()->query('from_date'),
                            'to_date' => request()->query('to_date'),
                        ])); ?>"
                            target="_blank" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <div class="col-12">
                    ...
                    <?php if(request()->query('from_date')): ?>
                        <div class="mb-3">
                            ...
                            <a class="ms-2 text-reset text-secondary" href="<?php echo e(route('barang-masuk.laporan')); ?>">Reset</a>
                        </div>
                    <?php endif; ?>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            Total : <?php echo e($barangMasukDetails->count()); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td data-label="Barang">
                                                <div class="d-flex flex-column align-items-top">
                                                    ...
                                                    <div class="font-weight-medium"><?php echo e($row->barangMasuk->tgl_masuk); ?>

                                                    </div>
                                                    <div class="text-secondary">
                                                        <a href="<?php echo e(route('barang-masuk.show', $row->barangMasuk->id)); ?>"
                                                            target="_blank"
                                                            class=""><?php echo e($row->barangMasuk->no_transaksi); ?></a>
                                                    </div>
                                            ...
                                            <td class="align-text-top" data-label="Pemasok">
                                                <?php echo e($row->barangMasuk->pemasok->nama_pemasok); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sisfo-barang-masuk-dan-keluar-main\resources\views/pages/barang-masuk/laporan/index.blade.php ENDPATH**/ ?>