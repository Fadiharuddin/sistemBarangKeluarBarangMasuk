        ...
        <div class="container-xl ">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="<?php echo e(route('barang.import.create')); ?>" class="btn btn-primary d-none d-sm-inline-block">
                            <i class="ti ti-table-import icon"></i>
                            Import
                        </a>
                        <a href="<?php echo e(route('barang.pdf')); ?>" target="_blank"
                            class="btn btn-primary d-none d-sm-inline-block">
                            <i class="ti ti-file-export icon"></i>
                            PDF
                        </a>
                        <a href="<?php echo e(route('barang.excel')); ?>" target="_blank"
                            class="btn btn-primary d-none d-sm-inline-block">
                            <i class="ti ti-table-export icon"></i>
                            Excel
                        </a>
                        <a href="<?php echo e(route('barang.create')); ?>" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">
                            <a class="dropdown-item" href="<?php echo e(route('barang.import.create')); ?>">
                                <i class="ti ti-table-import icon text-secondary me-2"></i>
                                Import
                            </a>
                            <a class="dropdown-item" href="<?php echo e(route('barang.excel')); ?>">
                                <i class="ti ti-table-export icon text-secondary me-2"></i>
                                Excel
                            </a>
                            <a class="dropdown-item" href="<?php echo e(route('barang.pdf')); ?>">
                                <i class="ti ti-file-export icon text-secondary me-2"></i>
                                PDF
                            </a>
                        </div>
                        
                        <a href="<?php echo e(route('barang.create')); ?>" class="btn btn-primary d-sm-none btn-icon">
                            <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="col-12 col-lg-3">
                    <form action="" method="get">
                        <div class="input-icon mb-3">
                            <input type="search" value="<?php echo e(request()->query('keyword')); ?>" class="form-control w-100"
                ...
                <div class="col-12">
                    <div class="card">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $barangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="text-secondary align-text-top" data-label="No">
                                                <?php echo e($loop->iteration + $barangs->firstItem() - 1); ?>

                                            </td>
                                            <td data-label="Barang">
                                                <div class="d-flex py-1 align-items-top">
                                                    <a data-fslightbox="gallery"
                                                        href="<?php echo e(asset('storage/' . $row->gambar)); ?>">
                                                        <span class="avatar me-2"
                                                            style="background-image: url(<?php echo e(asset('storage/' . $row->gambar)); ?>)"></span>

                                                    </a>
                                                    <div class="flex-fill">
                                                        <div class="font-weight-medium"><?php echo e($row->nama_barang); ?></div>
                                                        <div class="text-secondary"><a href="#"
                                                                class="text-reset"><?php echo e($row->kode); ?></a></div>
                                                    </div>
                                                </div>
                                            </td>

                                            <td class="align-text-top" data-label="Satuan">
                                                <?php echo e($row->satuan->nama_satuan); ?>

                                            </td>
                                            <td class="align-text-top" data-label="Kategori">
                                                <?php $__empty_2 = true; $__currentLoopData = $row->kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                    <span
                                                        class="badge badge-outline text-cyan"><?php echo e($item->nama_kategori); ?></span>
                                            ...
                                            <td class="align-text-top">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end" style="">
                                                    <a class="dropdown-item" href="<?php echo e(route('barang.edit', $row->id)); ?>">
                                                        <i class="ti ti-edit icon text-secondary me-2"></i>
                                                        Edit
                                                    </a>
                                                    <a class="dropdown-item text-danger" href="#"
                                                        onclick="handleDelete(`<?php echo e(route('barang.destroy', $row->id)); ?>`)">
                        ...
                        <div class="card-footer d-flex justify-content-center align-items-center">
                            <?php echo e($barangs->onEachSide(1)->withQueryString()->withPath(request()->fullUrl())->links()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sisfo-barang-masuk-dan-keluar-main\resources\views/pages/barang/index.blade.php ENDPATH**/ ?>