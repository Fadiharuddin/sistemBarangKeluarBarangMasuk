                    ...
                    <div class="card card-md">
                        <form action="<?php echo e(route('kategori.store')); ?>" method="POST">
                            ...
                            <div class="card-header">
                                <a href="<?php echo e(route('kategori.index')); ?>" class="btn btn-icon">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nama_kategori" value="<?php echo e(old('nama_kategori')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="card-footer">
                                <a href="<?php echo e(route('kategori.index')); ?>" class="btn btn-outline-secondary w-25 ">Cancel</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sisfo-barang-masuk-dan-keluar-main\resources\views/pages/kategori/create.blade.php ENDPATH**/ ?>